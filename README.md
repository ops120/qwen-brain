...
**v1 未自动化**：AI 生图 / AI 生视频 / PPT 创作 / 工作助理 / 定时任务
（这些是工具栏「入口型」功能，进入独立工作流，不属于对话流）。
...
- **生图 / 生视频 / PPT 未自动化**（v1）：入口型功能，需网页手动操作。
...
| 生图 | 登录入口（未自动化） | ✗ | ✓（2816×1536 原图） | ✓（2048×2048） | ✗ |
| 生视频 | 登录入口（未自动化） | ✗ | ✗ | ✓（1280×720） | ✗ |
